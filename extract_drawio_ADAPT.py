...
def extract_information(xml_path, base_name):
    ...
    for user_object in root.findall('.//UserObject') + root.findall('.//object'):
        ...
        if btelligentLibrary == 'ADAPT' and adapttype in ["Dimension", "LoosePrecedence", "Hierarchy", "StrictPrecedence", , "DimensionMember", "DimensionScope", "Function", "HierarchyLevel", "Attribute", "MeasureGroup", "MeasureDimension"]: 
