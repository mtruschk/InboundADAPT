...
def extract_information(xml_path, base_name):
    ...
    for user_object in root.findall('.//UserObject') + root.findall('.//object'):
        ...
        if btelligentLibrary == 'ADAPT': 
            #and adapttype and adapttype in ["Dimension", "LoosePrecedence", "StrictPrecedence", "Hierarchy", "DimensionMember", "DimensionScope", "Function", "HierarchyLevel", "Attribute", "MeasureGroup", "MeasureDimension", "Hub", "Link", "Satellite", "Hub-to-Sat", "Hub-to-Link-N", "Hub-to-Link-1"]:
